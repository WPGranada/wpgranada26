...
<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.6"}},"fontSize":"medium","fontFamily":"body"} -->
<p class="has-body-font-family has-medium-font-size" style="line-height:1.6">Una comunidad abierta de personas que quieren aprender, crear proyectos web y compartir conocimiento sobre WordPress: diseño, desarrollo, negocios y tecnología.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-base-color has-accent-background-color has-text-color has-background has-body-font-family has-medium-font-size has-custom-font-size wp-element-button" href="https://www.meetup.com/es-ES/wordpress-granada/" style="border-radius:100px;padding-top:0.875rem;padding-right:2rem;padding-bottom:0.875rem;padding-left:2rem">Únete a las Meetup</a></div>
<!-- /wp:button -->

<!-- wp:button {"backgroundColor":"primary","textColor":"base","style":{"border":{"radius":"100px"},"spacing":{"padding":{"top":"0.875rem","bottom":"0.875rem","left":"2rem","right":"2rem"}}},"fontSize":"medium","fontFamily":"body"} -->
<div class="wp-block-button"><a class="wp-block-button__link has-base-color has-primary-background-color has-text-color has-background has-body-font-family has-medium-font-size has-custom-font-size wp-element-button" href="/actividades" style="border-radius:100px;padding-top:0.875rem;padding-right:2rem;padding-bottom:0.875rem;padding-left:2rem">Ver actividades</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:post-date {"format":"j M","metadata":{"bindings":{"datetime":{"source":"core/post-data","args":{"field":"date"}}}},"style":{"typography":{"fontWeight":"700","textTransform":"uppercase","letterSpacing":"0.1em"}},"textColor":"primary","fontSize":"x-small","fontFamily":"body"} /--></div>
<!-- /wp:group -->

<!-- wp:post-title {"level":3,"style":{"typography":{"fontWeight":"700","lineHeight":"1.2"}},"fontSize":"x-large","fontFamily":"heading"} /-->
