...
/**
 * Title: Ser Ponente
 * Slug: wpgranada26/ser-ponente
 * Categories: wpgranada
 * Description: Sección para invitar a ser ponente con formulario de Gravity Forms.
 * Keywords: ponente, speaker, formulario, charla
 */
?>
...
<h1 class="wp-block-heading ser-ponente-title has-primary-color has-text-color has-heading-font-family" style="font-weight:800;line-height:0.95">Ser Ponente</h1>
<!-- /wp:heading -->
...
<p class="has-accent-color has-text-color has-body-font-family has-x-small-font-size" style="font-weight:700;letter-spacing:0.1em;text-transform:uppercase">Estamos construyendo y fortaleciendo una comunidad tecnológica en Granada</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"muted","fontSize":"small","fontFamily":"body"} -->
<p class="has-muted-color has-text-color has-body-font-family has-small-font-size">Estamos preparando las próximas charlas y talleres de la comunidad WordPress Granada para 2025, y nos encantaría contar contigo si tienes algo que compartir.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"muted","fontSize":"small","fontFamily":"body"} -->
<p class="has-muted-color has-text-color has-body-font-family has-small-font-size">Puede ser sobre WordPress, desarrollo web, marketing digital, IA, SEO, soft skills, diseño o cualquier tema útil para quienes trabajan en el sector.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:group {"className":"ponente-reason","style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top"}} -->
<div class="wp-block-group ponente-reason"><!-- wp:paragraph {"className":"ponente-reason__icon","textColor":"accent","fontSize":"medium"} -->
<p class="ponente-reason__icon has-accent-color has-text-color has-medium-font-size">◎</p>
<!-- /wp:paragraph -->
