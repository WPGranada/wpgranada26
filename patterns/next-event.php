...
<div class="wp-block-group alignfull">
	...
	<div class="wp-block-group">
		...
		<p class="has-primary-color has-text-color has-body-font-family has-x-small-font-size is-label">PRÓXIMO EVENTO</p>
		<!-- /wp:paragraph -->
	...
	<div class="wp-block-query">
		...
		<!-- wp:post-template {"layout":{"type":"default"}} -->
			...
			<div class="wp-block-group next-event-card has-base-background-color has-background has-border-color">

				<!-- wp:columns {"style":{"spacing":{"blockGap":"0"}}} -->
				<div class="wp-block-columns">

					<!-- wp:column {"width":"46%","className":"next-event-image-col"} -->
					<div class="wp-block-column next-event-image-col">
					...
					<div class="wp-block-column">
						...
						<div class="wp-block-group next-event-body">
							...
							<div class="wp-block-group has-primary-background-color has-background event-date-badge">
